...
import OrdersCards from "../components/OrdersHistory/OrdersCardsList";
...
const OrdersHistory: React.FC = () => {
  ...
  return (
    <>
      <div className="relative mt-[56px] min-h-screen p-3 bg-white">
                    ...
                    <div className="p-2">
                      ...
                      <div className="flex ">
                        <div>
                          ...
                          <p className="payment-details">
                            Purchased Date:- {dayjs(item?.createdAt).format("DD-MM-YYYY")}
                          </p>
